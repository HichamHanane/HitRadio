...
//                 document.getElementById('currentCity').innerHTML = position.coords.longitude
...
//     let getCurrent = await getCurrentLocation()


//     new Promise((resolve, reject) => {

//     })
//     console.log('Position :', getCurrent);

//     // console.log('hello test');
//     // try {
//     //     let post = await axios.get('https://api.openweathermap.org/data/2.5/weather?q=Agadir&appid=df44f85ddab485da6f7ffca1cee027ef&units=metric');

//     // console.log('Response :',Math.round(post.data.main.temp));
//     // } catch (error) {
